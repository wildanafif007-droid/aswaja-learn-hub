...
const GFORM_PREFILL =
  "https://docs.google.com/forms/d/e/1FAIpQLScUDdlP_DH9m0fjFpgoPQNYzDoQ-9C6sAYTWjKBrkUyQXSq2Q/viewform?usp=header";
...
function KuisPage() {
  ...
  const simpanHasil = (skorBaru: number) => {
    ...
    const bestSkor = Math.max(prev?.bestSkor ?? 0, skorBaru);
    const data: Hasil = {
      nama,
      kelas,
      babId,
    ...
    localStorage.setItem(SESI_KEY, JSON.stringify(data));
    setHasil(data);
    setSelesai(true);
  };
